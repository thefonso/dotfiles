...
silent only
cd ~/Sites/cp2/rails_in_20
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 chapter03/part7.html
badd +57 chapter03/part8.html
badd +74 chapter03/part8b.html
badd +21 chapter03/part8c.html
badd +2 chapter03/part12.html
badd +8 index.html
args ./
