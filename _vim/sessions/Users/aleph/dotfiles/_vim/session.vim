...
set pyxversion=2
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Command-T,~/.vim/bundle/html5.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/pathogen.vim,~/.vim/bundle/surround.vim,~/.vim/bundle/tComment,~/.vim/bundle/vim-coffee-script,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-golang,~/.vim/bundle/vim-javascript,~/.vim/bundle/vim-powerline,~/.vim/bundle/vim-ruby,~/.vim/bundle/VimClojure,/usr/local/Cellar/macvim/8.0-131/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/8.0-131/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/8.0-131/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/bundle/vim-javascript/after,~/.vim/bundle/vim-coffee-script/after,~/.vim/bundle/html5.vim/after,~/.vim/after
set scrolloff=5
set shiftwidth=2
set showmatch
set smartcase
...
set shortmess=aoO
badd +0 update_bundle.rb
argglobal
silent! argdel *
$argadd update_bundle.rb
edit update_bundle.rb
...
setlocal path=/usr/local/lib/ruby/site_ruby/2.4.0,/usr/local/lib/ruby/site_ruby/2.4.0/x86_64-darwin14,/usr/local/lib/ruby/site_ruby,/usr/local/lib/ruby/vendor_ruby/2.4.0,/usr/local/lib/ruby/vendor_ruby/2.4.0/x86_64-darwin14,/usr/local/lib/ruby/vendor_ruby,/usr/local/Cellar/ruby/2.4.1/lib/ruby/2.4.0,/usr/local/Cellar/ruby/2.4.1/lib/ruby/2.4.0/x86_64-darwin14
...
setlocal tabstop=2
setlocal tagcase=
setlocal tags=./tags,tags,/usr/local/lib/ruby/site_ruby/2.4.0/tags,/usr/local/lib/ruby/site_ruby/2.4.0/x86_64-darwin14/tags,/usr/local/lib/ruby/site_ruby/tags,/usr/local/lib/ruby/vendor_ruby/2.4.0/tags,/usr/local/lib/ruby/vendor_ruby/2.4.0/x86_64-darwin14/tags,/usr/local/lib/ruby/vendor_ruby/tags,/usr/local/Cellar/ruby/2.4.1/lib/ruby/2.4.0/tags,/usr/local/Cellar/ruby/2.4.1/lib/ruby/2.4.0/x86_64-darwin14/tags
