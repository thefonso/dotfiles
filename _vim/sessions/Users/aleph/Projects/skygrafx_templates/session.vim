...
silent only
cd ~/Projects/skygrafx_templates
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 onassis/Theme/index.html
badd +1 ~/Projects/skygrafx_templates/
argglobal
silent! argdel *
argadd ~/Projects/skygrafx_templates/
edit onassis/Theme/index.html
...
let s:l = 260 - ((15 * winheight(0) + 25) / 51)
