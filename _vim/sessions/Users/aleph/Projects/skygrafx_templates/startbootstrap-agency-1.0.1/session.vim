...
silent only
cd ~/Projects/skygrafx_templates/startbootstrap-agency-1.0.1
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +659 index.html
badd +1 css/agency.css
badd +1 .git/config
badd +1 ~/Projects/skygrafx/.git/config
badd +1 ~/Projects/skygrafx_templates/startbootstrap-agency-1.0.1
badd +8 site/Gemfile
badd +2 site/config.ru
badd +16 site/public/index.html
badd +2 config.ru
badd +6 Gemfile
badd +1 Procfile
badd +663 public/index.html
argglobal
silent! argdel *
argadd ~/Projects/skygrafx_templates/startbootstrap-agency-1.0.1
edit index.html
...
exe 'vert 1resize ' . ((&columns * 127 + 91) / 182)
exe 'vert 2resize ' . ((&columns * 54 + 91) / 182)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal tabstop=2
setlocal tags=~/Projects/skygrafx_templates/startbootstrap-agency-1.0.1/.git/html.tags,~/Projects/skygrafx_templates/startbootstrap-agency-1.0.1/.git/tags,./tags,tags
...
let s:l = 677 - ((36 * winheight(0) + 25) / 51)
...
setlocal tabstop=2
setlocal tags=~/Projects/skygrafx_templates/startbootstrap-agency-1.0.1/.git/css.tags,~/Projects/skygrafx_templates/startbootstrap-agency-1.0.1/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 178 - ((18 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
178
