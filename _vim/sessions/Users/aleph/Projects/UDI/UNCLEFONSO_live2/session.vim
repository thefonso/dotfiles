...
silent only
cd ~/projects/UDI/UNCLEFONSO_live2
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +6 00-week/ruby_basics/05_methods/01-methods-definition.rb
...
badd +1 00-week/ruby_basics/05_methods/README.md
badd +13 00-week/ruby_basics/06_classes/05-class-defined.rb
argglobal
silent! argdel *
$argadd .
edit 00-week/ruby_basics/05_methods/01-methods-definition.rb
