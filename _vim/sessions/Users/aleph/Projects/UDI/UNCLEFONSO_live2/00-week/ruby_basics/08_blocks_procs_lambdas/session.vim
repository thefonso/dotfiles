...
silent only
cd ~/projects/UDI/UNCLEFONSO_live2/00-week/ruby_basics/08_blocks_procs_lambdas
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 20_block_procs_examples.rb
argglobal
silent! argdel *
$argadd 20_block_procs_examples.rb
edit 20_block_procs_examples.rb
...
let s:l = 116 - ((5 * winheight(0) + 21) / 42)
