...
silent only
cd ~/projects/UDI/UNCLEFONSO_live2/00-week/ruby_basics/05_methods
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 01-methods-definition.rb
argglobal
silent! argdel *
$argadd 01-methods-definition.rb
edit 01-methods-definition.rb
