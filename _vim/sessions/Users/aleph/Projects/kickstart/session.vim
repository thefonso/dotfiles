...
silent only
cd ~/Projects/kickstart
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +46 cheatsheets/arrays.rb
badd +1 session5/notes/01-modules-introduction.rb
badd +1 session5/notes/02-modules-including.rb
badd +46 cheatsheets/hashes.rb
badd +1 session1/notes/21-true-and-false.rb
badd +5 session1/notes/02-conventions.rb
badd +0 NERD_tree_2
argglobal
silent! argdel *
argadd ~/Projects/kickstart/
