...
silent only
cd ~/projects/UNCLEFONSO_live
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +34 00-week/ruby_basics/00_strings/00-local-variables.rb
badd +0 ~/projects/UDI/UNCLEFONSO_live
argglobal
silent! argdel *
$argadd ~/projects/UDI/UNCLEFONSO_live
edit 00-week/ruby_basics/00_strings/00-local-variables.rb
...
exe 'vert 1resize ' . ((&columns * 25 + 79) / 159)
exe 'vert 2resize ' . ((&columns * 133 + 79) / 159)
argglobal
enew
file NERD_tree_2
let s:cpo_save=&cpo
