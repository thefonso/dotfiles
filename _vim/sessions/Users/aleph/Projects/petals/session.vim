...
set shortmess=aoO
badd +29 Gemfile
badd +51 config/database.yml
badd +4 config/routes.rb
badd +1 app/controllers/accounts_controller.rb
badd +30 spec/controllers/accounts_controller_spec.rb
badd +2 .rspec
args ./
