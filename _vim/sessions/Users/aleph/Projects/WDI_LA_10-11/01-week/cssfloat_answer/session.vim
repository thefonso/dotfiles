...
silent only
cd ~/Projects/WDI_LA_10-11/01-week/cssfloat_answer
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 index.html
badd +0 css/stylesheet.css
args .
edit index.html
...
exe 'vert 1resize ' . ((&columns * 81 + 63) / 127)
exe 'vert 2resize ' . ((&columns * 45 + 63) / 127)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal tabstop=2
setlocal tags=~/Projects/WDI_LA_10-11/.git/html.tags,~/Projects/WDI_LA_10-11/.git/tags,./tags,tags
...
16
normal! 016l
lcd ~/Projects/WDI_LA_10-11/01-week/cssfloat_answer
wincmd w
argglobal
edit ~/Projects/WDI_LA_10-11/01-week/cssfloat_answer/css/stylesheet.css
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
setlocal tabstop=2
setlocal tags=~/Projects/WDI_LA_10-11/.git/css.tags,~/Projects/WDI_LA_10-11/.git/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
