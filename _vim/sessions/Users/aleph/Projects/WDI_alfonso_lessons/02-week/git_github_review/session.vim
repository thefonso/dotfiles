...
silent only
cd ~/Projects/WDI_alfonso_lessons/02-week/git_github_review
...
setlocal tabstop=2
setlocal tags=~/Projects/WDI_alfonso_lessons/.git/nerdtree.tags,~/Projects/WDI_alfonso_lessons/.git/tags,./tags,tags
...
lcd ~/Projects/WDI_alfonso_lessons/02-week/git_github_review
tabnext 1
if exists('s:wipebuf')
