...
silent only
cd ~/Projects/WDI_alfonso_lessons/08-week/raptest
...
badd +6 spec/rails_helper.rb
badd +12 spec/models/rapper_spec.rb
badd +1 spec/models/song_spec.rb
badd +2 .rspec
badd +0 app/models/rapper.rb
silent! argdel *
edit spec/models/song_spec.rb
...
exe 'vert 3resize ' . ((&columns * 62 + 91) / 182)
argglobal
enew
file NERD_tree_3
let s:cpo_save=&cpo
