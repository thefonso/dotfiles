...
silent only
cd ~/projects/ruby_lessons
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +35 lesson1/lecture/04-class-example.rb
badd +14 lesson5/lecture/14_gems_intro.rb
badd +1 readme.md
badd +0 lesson6/lecture/06_sinatra_views_layouts_more/main.rb
argglobal
silent! argdel *
$argadd .
edit lesson6/lecture/06_sinatra_views_layouts_more/main.rb
