...
silent only
cd ~/projects/WDI/UNCLEFONSO_student/00-prework/ruby_basics/06_blocks_procs_lambdas
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 enumerables.html
argglobal
silent! argdel *
$argadd enumerables.html
edit enumerables.html
...
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <SNR>31_ragtagOclose  ><Left><Left>
inoremap <buffer> <SNR>31_ragtagOopen <%= 
inoremap <buffer> <SNR>31_xhtmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
inoremap <buffer> <SNR>31_htmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
normal! zt
2
let s:c = 241 - ((151 * winwidth(0) + 91) / 182)
if s:c > 0
  exe 'normal! ' . s:c . '|zs' . 241 . '|'
else
  normal! 0241|
endif
tabnext 1
