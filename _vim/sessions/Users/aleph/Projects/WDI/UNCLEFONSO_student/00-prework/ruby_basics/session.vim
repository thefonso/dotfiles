...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Command-T,~/.vim/bundle/html5.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/pathogen.vim,~/.vim/bundle/surround.vim,~/.vim/bundle/tComment,~/.vim/bundle/vim-coffee-script,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-golang,~/.vim/bundle/vim-javascript,~/.vim/bundle/vim-powerline,~/.vim/bundle/vim-rbenv,~/.vim/bundle/vim-ruby,~/.vim/bundle/VimClojure,/usr/local/Cellar/macvim/8.0-129/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/8.0-129/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/8.0-129/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/bundle/vim-javascript/after,~/.vim/bundle/vim-coffee-script/after,~/.vim/bundle/html5.vim/after,~/.vim/after
set scrolloff=5
set shiftwidth=2
set showmatch
set smartcase
...
silent only
cd ~/projects/WDI/UNCLEFONSO_student/00-prework/ruby_basics
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 04_classes/06b_class-inheritance.rb
badd +1 ~/projects/WDI/UNCLEFONSO_student/00-prework/ruby_basics
badd +31 01b_arrays/03-array-iterating.rb
badd +24 01b_arrays/04-array-filtering.rb
badd +58 01b_hashes/labs/enumerables.rb
badd +35 01b_arrays/05-array-other-methods.rb
badd +136 ~/.vimrc
badd +42 01b_arrays/06-array_examples.rb
badd +63 01b_arrays/06-array-more-examples.rb
badd +2 01b_arrays/02-arrays.rb
badd +21 01b_arrays/labs/prompts.md
badd +19 01b_arrays/labs/README.md
badd +1 01b_arrays/labs/prompts.rb
badd +19 01b_arrays/README.md
badd +1 01_conditionals/ruby_conditionals.rb
badd +1 01_conditionals/ruby_operators.md
badd +1 02_loops/break_next_redo_retry.rb
badd +2 02_loops/while_until_for.rb
badd +1 02_loops/01_while_until_for.rb
badd +1 03_methods/02b-methods.rb
badd +1 03_methods/01-object-definition.rb
badd +1 03_methods/02-methods-definition.rb
badd +4 03_methods/04-method-arguments.rb
badd +1 05_modules/ruby_modules.rb
badd +2 05_modules/labs/superhero.rb
badd +1 04_classes/17-singleton-classes.rb
badd +22 05_modules/README.md
badd +1 05b_mixins/01_mixins_introduction.rb
badd +9 05b_mixins/support.rb
badd +0 05b_mixins/decade.rb
badd +13 05_modules/01-modules-introduction.rb
badd +19 05_modules/02-modules-including.rb
badd +1 05_modules/05_modules_and_nesting_classes.rb
badd +33 05_modules/06_modules_namespacing.rb
badd +46 05_modules/ruby_modules_examples.rb
badd +85 05b_mixins/01_modules_mixins_introduction.md
argglobal
silent! argdel *
$argadd ~/projects/WDI/UNCLEFONSO_student/00-prework/ruby_basics
edit 05_modules/02-modules-including.rb
