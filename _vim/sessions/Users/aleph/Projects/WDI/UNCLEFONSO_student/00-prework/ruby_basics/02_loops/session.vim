...
silent only
cd ~/projects/WDI/UNCLEFONSO_student/00-prework/ruby_basics/02_loops
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 while_until_for.rb
badd +0 01_while_modifier.rb
argglobal
silent! argdel *
$argadd while_until_for.rb
edit 01_while_modifier.rb
