...
silent only
cd ~/projects/WDI/UNCLEFONSO_student/00-prework/ruby_basics/01_conditionals
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ruby_conditionals.rb
argglobal
silent! argdel *
$argadd ruby_conditionals.rb
edit ruby_conditionals.rb
...
let s:l = 60 - ((39 * winheight(0) + 25) / 51)
