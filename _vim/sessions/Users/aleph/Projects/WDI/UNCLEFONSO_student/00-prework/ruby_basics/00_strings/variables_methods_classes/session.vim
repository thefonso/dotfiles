...
silent only
cd ~/projects/WDI/UNCLEFONSO_student/00-prework/ruby_basics/00_strings/variables_methods_classes
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 07-methods.rb
badd +1 03-object-definition.rb
argglobal
silent! argdel *
$argadd 03-object-definition.rb
edit 03-object-definition.rb
