...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Command-T,~/.vim/bundle/html5.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/pathogen.vim,~/.vim/bundle/surround.vim,~/.vim/bundle/tComment,~/.vim/bundle/vim-coffee-script,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-golang,~/.vim/bundle/vim-javascript,~/.vim/bundle/vim-powerline,~/.vim/bundle/vim-ruby,~/.vim/bundle/VimClojure,/usr/local/Cellar/macvim/8.0-128/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/8.0-128/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/8.0-128/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/bundle/vim-javascript/after,~/.vim/bundle/vim-coffee-script/after,~/.vim/bundle/html5.vim/after,~/.vim/after
set scrolloff=5
set shiftwidth=2
set showmatch
set smartcase
...
silent only
cd ~/projects/WDI/UNCLEFONSO_instructor
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +17 00-prework/ruby_basics/00_strings/console_and_strings.rb
badd +1 ~/projects/WDI/UNCLEFONSO_instructor
badd +1 00-prework/ruby_basics/00_strings/ruby_basics.rb
argglobal
silent! argdel *
$argadd ~/projects/WDI/UNCLEFONSO_instructor
edit 00-prework/ruby_basics/00_strings/ruby_basics.rb
