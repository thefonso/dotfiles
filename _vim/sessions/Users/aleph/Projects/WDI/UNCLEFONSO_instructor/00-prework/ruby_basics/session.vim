...
silent only
cd ~/projects/WDI/UNCLEFONSO_instructor/00-prework/ruby_basics
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 00_strings/ruby_basics.rb
badd +1 ~/projects/WDI/UNCLEFONSO_instructor/00-prework/ruby_basics
argglobal
silent! argdel *
$argadd ~/projects/WDI/UNCLEFONSO_instructor/00-prework/ruby_basics
edit 00_strings/ruby_basics.rb
...
let s:l = 54 - ((27 * winheight(0) + 25) / 51)
