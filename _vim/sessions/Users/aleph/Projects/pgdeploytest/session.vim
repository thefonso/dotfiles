...
silent only
cd ~/Projects/pgdeploytest
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 /private/var/folders/_w/98n31_kn03qfjt51p2hmrfqh0000gp/T/psql.edit.5932.sql
...
let s:l = 22 - ((16 * winheight(0) + 18) / 37)
