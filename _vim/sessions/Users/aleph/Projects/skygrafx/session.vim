...
silent only
cd ~/Projects/skygrafx
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 README.md
badd +75 app/views/home/index.html.erb
badd +18 Gemfile
badd +9 config/routes.rb
badd +2 app/views/contacts/_form.html.erb
badd +1 ~/Projects/skygrafx
badd +6 app/views/contacts/new.html.erb
badd +22 config/unicorn.rb
badd +1 Procfile
badd +46 public/index.html
badd +1 public/css/agency.css
badd +13 app/assets/stylesheets/application.css
badd +1 app/assets/stylesheets/scaffolds.css.scss
badd +1 public/js/jquery.js
badd +1 app/assets/javascripts/application.js
badd +728 public/less/agency.less
badd +1 app/assets/javascripts/agency.js
badd +21 app/assets/javascripts/bootstrap.js
badd +1 app/assets/javascripts/classie.js
badd +1 app/assets/javascripts/contact_me.js
badd +1 app/assets/stylesheets/agency.css
badd +1 app/assets/stylesheets/bootstrap.css
argglobal
silent! argdel *
argadd ~/Projects/skygrafx
...
setlocal path=.,lib,vendor,app/models/concerns,app/controllers/concerns,app/controllers,app/helpers,app/mailers,app/models,app/*,app/views,app/views/application,public,spec,spec/controllers,spec/helpers,spec/mailers,spec/models,spec/views,spec/lib,spec/features,spec/requests,spec/integration,vendor/plugins/*/lib,vendor/plugins/*/test,vendor/rails/*/lib,vendor/rails/*/test,~/Projects/skygrafx,/usr/include,,~/.rbenv/versions/2.1.2/lib/ruby/gems/2.1.0/gems/font-awesome-rails-4.2.0.0/app/*,~/.rbenv/versions/2.1.2/lib/ruby/gems/2.1.0/gems/twitter-bootstrap-rails-3.2.0/app/*
...
setlocal tabstop=2
setlocal tags=~/Projects/skygrafx/tags,~/Projects/skygrafx/tmp/tags,~/Projects/skygrafx/.git/javascript.tags,~/Projects/skygrafx/.git/tags,./tags,tags
