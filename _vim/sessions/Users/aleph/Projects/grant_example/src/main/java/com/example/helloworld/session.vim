...
silent only
cd ~/Projects/grant_example/src/main/java/com/example/helloworld
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 HelloWorldConfiguration.java
argglobal
silent! argdel *
argadd HelloWorldConfiguration.java
edit HelloWorldConfiguration.java
...
setlocal tabstop=2
setlocal tags=~/Projects/grant_example/.git/java.tags,~/Projects/grant_example/.git/tags,./tags,tags
