...
silent only
cd ~/Projects/pgtestclassone
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +42 config/database.yml
...
setlocal tabstop=2
setlocal tags=~/Projects/pgtestclassone/tags,~/Projects/pgtestclassone/tmp/tags,~/Projects/pgtestclassone/.git/yaml.tags,~/Projects/pgtestclassone/.git/tags,./tags,tags
...
let s:l = 38 - ((5 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
normal! 0
lcd ~/Projects/pgtestclassone
tabnext 1
if exists('s:wipebuf')
