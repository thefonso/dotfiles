...
silent only
cd ~/UNCLEFONSO_live/00-week/ruby_basics
...
badd +1 ~/.gvimrc
badd +1 ~/.vimrc
badd +18 00_strings/20-go-do-labs.rb
badd +1 01_conditionals/lab/solutions/air_conditioning-solution.rb
badd +1 03_hashes/challenge/10_hashes.rb
badd +1 03_hashes/labs/mta/mta-solution.rb
badd +1 03_hashes/labs/mta/mta.md
badd +1 03_hashes/labs/enumerables.rb
badd +1 ~/UNCLEFONSO_live/00-week/ruby_basics
badd +37 01_conditionals/ruby_conditionals.rb
badd +1 01_conditionals/lab/conditionals_lab.md
badd +1 01_conditionals/ruby_operators.md
badd +20 02_arrays/README.md
badd +1 01_conditionals/README.md
badd +9 00_strings/README.md
badd +35 02_arrays/00-arrays.rb
badd +26 02_arrays/01-array-iterating.rb
badd +18 02_arrays/02-array-filtering.rb
badd +33 02_arrays/03-array-other-methods.rb
badd +37 02_arrays/04-array-more-examples.rb
badd +20 03_hashes/README.md
badd +19 03_hashes/01_Hash_initializing.rb
badd +23 03_hashes/02_Hash_access_assign.rb
badd +8 03_hashes/03_Hash_iterating.rb
badd +1 03_hashes/04_Hash_methods.rb
badd +17 03_hashes/05_Hash_notation.rb
badd +26 03_hashes/06_Hash_symbols.rb
badd +31 03_hashes/07_Hash_lesson_review.rb
badd +17 03_hashes/08_Hash_resources.rb
badd +9 03_hashes/00_Hash_intro.rb
badd +15 04_loops/README.md
badd +13 04_loops/00_while_until_for.rb
badd +29 04_loops/01_while_modifier.rb
badd +21 04_loops/02_break_next.rb
badd +1 04_loops/modifier.md
badd +28 05_methods/README.md
badd +9 05_methods/00-object-definition.rb
badd +13 05_methods/01-methods-definition.rb
badd +52 _02-ruby-object-definition.rb
badd +9 06_classes/05-class-defined.rb
badd +24 cheatsheets\ /04-introspection.rb
badd +1 cheatsheets\ /reflection-introspection.rb
badd +1 08_modules_mixins/labs/README.md
badd +9 08_modules_mixins/01-modules-introduction.rb
badd +1 07_classes/README.md
badd +91 08_modules_mixins/readme.md
badd +9 08_modules_mixins/support.rb
badd +1 08_modules_mixins/02-modules-including.rb
badd +22 08_modules_mixins/03_modules_namespacing.rb
badd +27 08_modules_mixins/04_modules_and_nesting_classes.rb
badd +11 08_modules_mixins/05_module_example.rb
badd +1 08_modules_mixins/labs/superhero.rb
badd +1 09_blocks_procs_lambdas/09_Blocks_intro.rb
badd +78 09_blocks_procs_lambdas/20_block_procs_examples.rb
badd +15 09_blocks_procs_lambdas/10_Blocks_yield_part1.rb
badd +14 09_blocks_procs_lambdas/10_Blocks_yield_part2.rb
badd +1 09_blocks_procs_lambdas/10_Blocks_yield_part3.rb
badd +14 09_blocks_procs_lambdas/11_Blocks_and_Procs.rb
badd +1 09_blocks_procs_lambdas/12_Procs_intro.rb
badd +14 09_blocks_procs_lambdas/13_Proc_syntax.rb
badd +20 09_blocks_procs_lambdas/14-storing-blocks-for-later.rb
badd +24 _00-intro.rb
badd +7 _01-conventions.rb
badd +20 09_blocks_procs_lambdas/01_Blocks_intro.rb
badd +3 09_blocks_procs_lambdas/02_Blocks_yield_part1.rb
badd +18 09_blocks_procs_lambdas/03_Blocks_yield_part2.rb
badd +1 09_blocks_procs_lambdas/09_storing_Blocks_for_later.rb
badd +1 09_blocks_procs_lambdas/10-storing-blocks-for-later.rb
badd +1 09_blocks_procs_lambdas/05_Blocks_and_Procs.rb
badd +18 09_blocks_procs_lambdas/04_Blocks_and_Procs.rb
badd +13 09_blocks_procs_lambdas/05_Procs_intro.rb
badd +37 09_blocks_procs_lambdas/07_storing_Blocks_for_later.rb
badd +25 09_blocks_procs_lambdas/06_Proc_syntax.rb
badd +12 09_blocks_procs_lambdas/08_passing_procs.rb
badd +1 09_blocks_procs_lambdas/09_Procs_can_see.rb
badd +37 09_blocks_procs_lambdas/13_block_procs_examples.rb
badd +22 09_blocks_procs_lambdas/10_lambda_intro.rb
badd +13 09_blocks_procs_lambdas/11_lambda.rb
badd +26 09_blocks_procs_lambdas/12_lambda_vs_proc.rb
badd +15 09_blocks_procs_lambdas/README.md
badd +1 00_overview/_00-intro.rb
badd +1 00_overview/_02-ruby-object-definition.rb
badd +12 00_overview/_01-conventions.rb
badd +7 00_overview/_03-keywords.rb
badd +1 cheatsheets\ /vim-cheatsheat-simple.png
badd +1 cheatsheets\ /vehicles.rb
badd +1 cheatsheets\ /strings.rb
badd +29 20_iterators/00_each_collect.rb
badd +34 00_syntax.rb
badd +22 05_ranges.rb
badd +1 00_overview/_04-self.rb
badd +25 10_random_coolstuff/06_files.rb
badd +1 10_random_coolstuff/07_working_dir_vs_file_dir.rb
badd +58 00_overview/_01_syntax.rb
badd +16 10_random_coolstuff/08_require_first.rb
badd +1 10_random_coolstuff/08_require_second.rb
argglobal
silent! argdel *
$argadd ~/UNCLEFONSO_live/00-week/ruby_basics
edit 10_random_coolstuff/08_require_first.rb
...
exe 'vert 1resize ' . ((&columns * 28 + 79) / 159)
exe 'vert 2resize ' . ((&columns * 130 + 79) / 159)
argglobal
enew
file NERD_tree_2
let s:cpo_save=&cpo
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/.rbenv/versions/2.0.0-p648/lib/ruby/site_ruby/2.0.0,~/.rbenv/versions/2.0.0-p648/lib/ruby/site_ruby/2.0.0/x86_64-darwin16.5.0,~/.rbenv/versions/2.0.0-p648/lib/ruby/site_ruby,~/.rbenv/versions/2.0.0-p648/lib/ruby/vendor_ruby/2.0.0,~/.rbenv/versions/2.0.0-p648/lib/ruby/vendor_ruby/2.0.0/x86_64-darwin16.5.0,~/.rbenv/versions/2.0.0-p648/lib/ruby/vendor_ruby,~/.rbenv/versions/2.0.0-p648/lib/ruby/2.0.0,~/.rbenv/versions/2.0.0-p648/lib/ruby/2.0.0/x86_64-darwin16.5.0
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal tabstop=2
setlocal tagcase=
setlocal tags=./tags,tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/site_ruby/2.0.0/tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/site_ruby/2.0.0/x86_64-darwin16.5.0/tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/site_ruby/tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/vendor_ruby/2.0.0/tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/vendor_ruby/2.0.0/x86_64-darwin16.5.0/tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/vendor_ruby/tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/2.0.0/tags,~/.rbenv/versions/2.0.0-p648/lib/ruby/2.0.0/x86_64-darwin16.5.0/tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
